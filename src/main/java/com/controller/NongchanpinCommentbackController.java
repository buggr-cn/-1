...
public class NongchanpinCommentbackController {
    ...
    private static final String TABLE_NAME = "nongchanpinCommentback";
    ...
    */
    ...
    public R update(@RequestBody NongchanpinCommentbackEntity nongchanpinCommentback, HttpServletRequest request) throws NoSuchFieldException, ClassNotFoundException, IllegalAccessException, InstantiationException {
        logger.debug("update方法:,,Controller:{},,nongchanpinCommentback:{}",this.getClass().getName(),nongchanpinCommentback.toString());
        NongchanpinCommentbackEntity oldNongchanpinCommentbackEntity = nongchanpinCommentbackService.selectById(nongchanpinCommentback.getId());//查询原先数据
...
//        else if("用户".equals(role))
//            nongchanpinCommentback.setYonghuId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
        if("".equals(nongchanpinCommentback.getNongchanpinCommentbackText()) || "null".equals(nongchanpinCommentback.getNongchanpinCommentbackText())){
                nongchanpinCommentback.setNongchanpinCommentbackText(null);
        }
        if("".equals(nongchanpinCommentback.getReplyText()) || "null".equals(nongchanpinCommentback.getReplyText())){
                nongchanpinCommentback.setReplyText(null);
        }
    ...
    */
    ...
    public R delete(@RequestBody Integer[] ids, HttpServletRequest request){
        ...
        List<NongchanpinCommentbackEntity> oldNongchanpinCommentbackList =nongchanpinCommentbackService.selectBatchIds(Arrays.asList(ids));//要删除的数据
...
//                            nongchanpinCommentbackEntity.setUpdateTime(sdf.parse(data.get(0)));          //回复时间 要改的
